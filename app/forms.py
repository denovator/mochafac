...
class JoinForm(Form):
    email = EmailField(
        u'이메일',
        [validators.data_required(u'사용하실 이메일을 입력해주세요.')],
        description={'placeholder': u'사용하실 이메일을 입력하세요.'}
    )

    password = PasswordField(
        u'패스워드',
        [validators.data_required(u'사용하실 패스워드를 입력해주세요.'),
        validators.EqualTo('confirm_password', message=u'패스워드가 일치하지 않습니다.')],
        description={'placeholder': u'사용하실 패스워드를 입력해주세요.'}
    )
    confirm_password = PasswordField(
        u'패스워드 확인',
        [validators.data_required(u'사용하실 패스워드를 한번 더 입력해주세요.')],
        description={'placeholder': u'사용하실 패스워드를 한번 더 입력해주세요.'}
    )
    name = StringField(
        u'이름',
        [validators.data_required(u'당신의 이름을 입력해주세요.')],
        description={'placeholder': u'당신의 이름을 입력하세요.'}
    )
